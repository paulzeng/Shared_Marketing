...
import com.ruanmeng.fragment.CustomerCaseFragment;
import com.ruanmeng.fragment.ManageFragment;
...
@RuntimePermissions
public class MainCaseActivity extends BaseActivity {

    @BindView(R.id.fl_case_main_container)
    FrameLayout mContainer;
    @BindView(R.id.rb_main_case_check_1)
    RadioButton rb_check1;
    @BindView(R.id.rb_main_case_check_2)
    RadioButton rb_check2;
    @BindView(R.id.rb_main_case_check_3)
    RadioButton rb_check3;

    private CustomerCaseFragment customer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (TextUtils.isEmpty(getString("city_name"))) {
            MainCaseActivityPermissionsDispatcher.needsPermissionWithCheck(this);
        } else {
            getSystem();
        }
    ...
    private FragmentPagerAdapter mFragmentPagerAdapter = new FragmentPagerAdapter(
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case R.id.rb_main_case_check_1:
                    customer = new CustomerCaseFragment();
                    return customer;
                case R.id.rb_main_case_check_2:
                    manage = new ManageFragment();
                    return manage;
                case R.id.rb_main_case_check_3:
    ...
    public void onMessageEvent(MessageEvent event) {
        if (customer != null) customer.updateList();
    }

    @Subscribe
    public void onMessageEvent(MainMessageEvent event) {
        if (TextUtils.equals("1", event.getId())) {
            getLocation(event.getName());
        }
    }

    @Subscribe(threadMode = ThreadMode.MAIN)
    public void onMessageEvent(ManageMessageEvent event) {
        if (manage != null) manage.updateList();
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        MainCaseActivityPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
