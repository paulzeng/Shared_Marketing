...
public class MainChannelActivity extends BaseActivity {
        ...
        getRequest(new CustomHttpListener<JSONObject>(baseContext, false, JSONObject.class) {
            ...
            public void doWork(JSONObject data, String code) {
                ...
                try {
                    ...
                    if (company != null) company.setLocation(obj.getString("name"), true);
    ...
    public void onMessageEvent(MainMessageEvent event) {
        if (TextUtils.equals("8", event.getId())) {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        MainChannelActivityPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
