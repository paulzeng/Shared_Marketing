...
@RuntimePermissions
public class MainSpecialistActivity extends BaseActivity {

    @BindView(R.id.fl_main_specialist_container)
    FrameLayout mContainer;
    @BindView(R.id.rb_main_specialist_check_1)
    RadioButton rb_check1;
    @BindView(R.id.rb_main_specialist_check_2)
    RadioButton rb_check2;

    private SpecialistFragment specialist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            if (TextUtils.isEmpty(getString("city_name"))) {
                MainSpecialistActivityPermissionsDispatcher.needsPermissionWithCheck(this);
            } else {
                getSystem();
            }
        ...
        private FragmentPagerAdapter mFragmentPagerAdapter = new FragmentPagerAdapter(
            ...
            public Fragment getItem(int position) {
                switch (position) {
                    case R.id.rb_main_specialist_check_1:
                        specialist = new SpecialistFragment();
                        return specialist;
                    case R.id.rb_main_specialist_check_2:
        ...
        public void doClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.iv_fragment_company_msg:
                    ...
                    break;
                case R.id.iv_fragment_company_search:
            ...
            getRequest(new CustomHttpListener<JSONObject>(baseContext, false, JSONObject.class) {
                ...
                public void doWork(JSONObject data, String code) {
                    ...
                    try {
                        ...
                        if (specialist != null) specialist.setLocation(obj.getString("name"));
        ...
        public void onMessageEvent(MainMessageEvent event) {
            if (TextUtils.equals("10", event.getId())) {
        ...
        public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
            ...
            MainSpecialistActivityPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
        }
