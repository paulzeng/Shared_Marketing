...
@RuntimePermissions
public class MainUnitActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (TextUtils.isEmpty(getString("city_name"))) {
            MainUnitActivityPermissionsDispatcher.needsPermissionWithCheck(this);
        } else {
            getSystem();
        }
    ...
    public void onMessageEvent(MainMessageEvent event) {
        if (TextUtils.equals("7", event.getId())) {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        MainUnitActivityPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
