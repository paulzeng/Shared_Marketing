...
public class MainDriverActivity extends BaseActivity {
    ...
    @BindView(R.id.fl_main_driver_container)
    FrameLayout mContainer;
    @BindView(R.id.rb_main_driver_check_1)
    RadioButton rb_check1;
    @BindView(R.id.rb_main_driver_check_2)
    RadioButton rb_check2;
    @BindView(R.id.rb_main_driver_check_3)
    RadioButton rb_check3;

    private DriverFragment first;
    private DriverOrderFragment second;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (TextUtils.isEmpty(getString("city_name"))) {
            MainDriverActivityPermissionsDispatcher.needsPermissionWithCheck(this);
        } else {
            getSystem();
        }
    ...
    private FragmentPagerAdapter mFragmentPagerAdapter = new FragmentPagerAdapter(
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case R.id.rb_main_driver_check_1:
                    first = new DriverFragment();
                    return first;
                case R.id.rb_main_driver_check_2:
                    second = new DriverOrderFragment();
                    return second;
                case R.id.rb_main_driver_check_3:
    ...
    public void doClick(View v) {
        switch (v.getId()) {
            // 客户
            case R.id.tv_fragment_company_location:
                startActivity(CityActivity.class);
                break;
            case R.id.iv_fragment_company_msg:
        ...
        getRequest(new CustomHttpListener<JSONObject>(baseContext, false, JSONObject.class) {
            ...
            public void doWork(JSONObject data, String code) {
                ...
                try {
                    ...
                    if (first != null) first.setLocation(obj.getString("name"), true);
    ...
    @Subscribe
    public void onGrabMessageEvent(DriverMessageEvent event) {
        if (TextUtils.equals("1", event.getId())) first.setRefreshList();
        if (TextUtils.equals("2", event.getId())) second.setRefreshList();
    }

    @Subscribe
    public void onMessageEvent(MainMessageEvent event) {
        if (TextUtils.equals("11", event.getId())) {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        MainDriverActivityPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
