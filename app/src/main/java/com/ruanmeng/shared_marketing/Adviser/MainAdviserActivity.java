...
@RuntimePermissions
public class MainAdviserActivity extends BaseActivity {

    @BindView(R.id.fl_case_main_container)
    FrameLayout mContainer;
    @BindView(R.id.rb_main_adviser_check_1)
    RadioButton rb_check1;
    @BindView(R.id.rb_main_adviser_check_2)
    RadioButton rb_check2;
    @BindView(R.id.rb_main_adviser_check_3)
    RadioButton rb_check3;

    private CustomerFragment customer;
    private GrabFragment grab;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (TextUtils.isEmpty(getString("city_name"))) {
            MainAdviserActivityPermissionsDispatcher.needsPermissionWithCheck(this);
        } else {
            getSystem();
        }
    ...
    private FragmentPagerAdapter mFragmentPagerAdapter = new FragmentPagerAdapter(
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case R.id.rb_main_adviser_check_1:
                    customer = new CustomerFragment();
                    return customer;
                case R.id.rb_main_adviser_check_2:
                    grab = new GrabFragment();
                    return grab;
                case R.id.rb_main_adviser_check_3:
    ...
    public void doClick(View v) {
        ...
        switch (v.getId()) {
            ...
            // 抢单
            case R.id.iv_fragment_grab_search:
                intent = new Intent(this, SearchActivity.class);
    ...
    public void onMessageEvent(MainMessageEvent event) {
        if (TextUtils.equals("2", event.getId())) {
            if (TextUtils.equals("抢单信息更新", event.getName())) {
                if (customer != null) customer.setRefreshList();
                if (grab != null) grab.setRefreshList();
            } else {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        MainAdviserActivityPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
