...
public class TeamDistributionActivity extends BaseActivity {
    ...
    public void init_title() {
        ...
        tvTitle.setText(getIntent().getStringExtra("name") + "的团队");
    ...
    public void getData(final int pindex, int status) {
        mRequest = NoHttp.createStringRequest(HttpIP.customerList3, Const.POST);
        ...
        getRequest(new CustomHttpListener<CustomerData>(baseContext, true, CustomerData.class) {
            ...
            public void doWork(CustomerData data, String code) {
                ...
                if (data.getData().getCount_list().size() > 0) {
                    ...
                    if (list_count.size() > 8) list_count.remove(8);
