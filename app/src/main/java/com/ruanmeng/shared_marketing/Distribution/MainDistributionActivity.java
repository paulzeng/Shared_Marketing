...
@RuntimePermissions
public class MainDistributionActivity extends BaseActivity {
    ...
    private DistributionFragment company;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (TextUtils.isEmpty(getString("city_name"))) {
            MainDistributionActivityPermissionsDispatcher.needsPermissionWithCheck(this);
        } else {
            getSystem();
        }
    ...
    private FragmentPagerAdapter mFragmentPagerAdapter = new FragmentPagerAdapter(
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case R.id.rb_main_channel_check_1:
                    company = new DistributionFragment();
                    return company;
                case R.id.rb_main_channel_check_2:
        ...
        getRequest(new CustomHttpListener<JSONObject>(baseContext, false, JSONObject.class) {
            ...
            public void doWork(JSONObject data, String code) {
                ...
                try {
                    ...
                    if (company != null) company.setLocation(obj.getString("name"));
    ...
    public void onMessageEvent(MainMessageEvent event) {
        if (TextUtils.equals("9", event.getId())) {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        MainDistributionActivityPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
