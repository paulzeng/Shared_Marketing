...
public class CustomerFragment extends Fragment {
    ...
    private String[] items = new String[]{ "已推荐", "去电", "到访", "认购", "签约", "结佣", "失效" };
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (!TextUtils.equals("5", user_type)
                && !TextUtils.equals("6", user_type))
            getNotice();
    ...
    private void init() {
        ...
        switch (user_type) {
            case "2":
                mStatus = 9;
                items = new String[]{ "全部", "已推荐", "去电", "到访", "认购", "签约", "结佣", "失效" };
            ...
            case "3":
                mStatus = 1;
                items = new String[]{ "未推荐", "已推荐", "去电", "到访", "认购", "签约", "结佣", "失效" };
